...
//higher order functions
  //functions are values you can assign to variables
...
var me = "Katie Jenkins"; //function has access to this variable

function greetMe() { //not passing in an argument
  console.log("Hello " + me + " !"); //reads the value of variable from outside scope.
}
